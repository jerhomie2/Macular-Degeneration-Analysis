...
```{r}
armd.gls2 <- gls(Vision ~ Baseline + Time*Trt, data = armd,
                 correlation = corSymm(form = ~4|Subject))
coef(armd.gls2) # beta-hat
sigma(armd.gls2) # sigma-hat
armd.gls2$modelStruct$corStruct #correlation parameters
```
